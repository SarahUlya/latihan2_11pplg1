...
import 'package:latihan2_11pplg1/Pages/saqu_splashscreen.dart';
...
class AppPagess {
  // lisr array
  static final pages = [
    GetPage(name: AppRoutes.sqsplash, page: () => SaquSplashscreen()),

    //
    // GetPage(name: AppRoutes.login, page: () => LoginPage(), binding: LoginBinding()),
    // GetPage(name: AppRoutes.home, page: () => HomePage(),),GetPage(name: AppRoutes.splashScreen, page: () => SplashScreenPage(), binding: SplashscreenBinding()),
